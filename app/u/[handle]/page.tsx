...
export default async function ProfilePage({
    ...
    return (
      <div className="flex min-h-screen items-center justify-center">
        <div className="text-center">
          ...
          <Link
            href="/"
            className="mt-4 block text-sm text-[#6C63FF]"
          >
            Back to Lyra
          </Link>
        </div>
  ...
  const hydratedRaw = await Promise.all(
    rawRankings.slice(0, 50).map(hydrateRanking)
  );
  ...
  const avgRating =
    rankings.length > 0
      ? (
          rankings.reduce((s, r) => s + r.rating, 0) / rankings.length
        ).toFixed(1)
      : null;
        ...
        <div className="flex flex-col items-center pb-8 pt-10 text-center">
          ...
          <div className="mt-5 flex items-center gap-6">
            <div className="text-center">
              ...
              <p className="text-[10px] uppercase tracking-wider text-[#8E8E93]">
                Ranked
              </p>
            </div>
            {avgRating && (
              <div className="text-center">
                <p
                  ...
                  style={{
                    color: ratingColor(parseFloat(avgRating)),
                  }}
                >
                  {avgRating}
                </p>
              ...
              {rankings.map((r) => (
                ...
                >
                  <div className="relative aspect-square bg-surface2">
                    ...
                    <div className="absolute right-2 top-2 rounded-lg bg-black/70 px-2 py-1 backdrop-blur-sm">
                      <span
