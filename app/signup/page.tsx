  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#0a0a0a] px-4">
      ...
      <div className="w-full max-w-sm rounded-3xl border border-white/[0.08] bg-[#141414] p-8">
        ...
        <p className="mb-6 text-sm text-[#8E8E93]">Start ranking your music</p>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <span className="absolute left-4 top-1/2 -translate-y-1/2 text-sm text-[#48484A]">@</span>
              <input
                type="text"
                value={handle}
                ...
                required
                className="w-full rounded-xl border border-white/[0.08] bg-[#1c1c1e] py-3 pl-8 pr-4 text-sm text-white placeholder-[#48484A] outline-none transition-colors focus:border-[#6C63FF]/60"
              />
            </div>
          </div>
          <div>
